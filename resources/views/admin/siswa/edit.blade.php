...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card card-warning">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('siswa.update', $siswa->id) }}" id="form-edit-siswa">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="NIK" class="form-control @error('NIK') is-invalid @enderror"
                                    value="{{ old('NIK', $siswa->NIK) }}" placeholder="Nomor Induk Kependudukan">
                                @error('NIK')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="no_telp"
                                        ...
                                        value="{{ old('no_telp', $siswa->no_telp) }}" placeholder="08xxxxxxxxxx">
                                    @error('no_telp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
            ...
            <div class="card-footer">
                ...
                <button type="submit" form="form-edit-siswa" class="btn btn-warning">
